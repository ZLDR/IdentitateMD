...
- **jsDelivr CDN** (primary) - High-performance CDN for logo distribution
  - Base URL: `https://cdn.jsdelivr.net/npm/@identitate-md/logos@1.3.4/`
...
- **unpkg CDN** (fallback) - Alternative CDN for logo distribution
  - Base URL: `https://unpkg.com/@identitate-md/logos/`
...
- **CDN (jsDelivr/unpkg)** - Published assets
  - Distribution of `@identitate-md/logos` npm package
...
- NPM publish workflow for `@identitate-md/logos` package
  - Published to: `https://www.npmjs.com/package/@identitate-md/logos`
...
- **Package Name:** `@identitate-md/logos`
- **Current Version:** 1.3.4
...
```javascript
import logoPath from "@identitate-md/logos/logos/anaf/horizontal/color.svg";
// or access metadata
import metadata from "@identitate-md/logos";
```
...
- Source: `/logos/:path*` → Destination: `https://cdn.jsdelivr.net/npm/@identitate-md/logos@1.3.4/logos/:path*`
- Source: `/loader.js` → Destination: `https://cdn.jsdelivr.net/npm/@identitate-md/logos@1.3.4/identity-loader.js`
...
_Integration audit: 2026-03-04_
